...
[^wcag21x]: WCAG 2.2 Understanding Docs. SC 2.1 Keyboard Accessible (Overview). Disponível em: [https://www.w3.org/WAI/WCAG22/Understanding/keyboard-accessible.html](https://www.w3.org/WAI/WCAG22/Understanding/keyboard-accessible.html). Acesso em: 15 nov 2025.
...
[^wcag12x]: WCAG 2.2 Understanding Docs. SC 1.2 Time-based Media (Overview). Disponível em: [https://www.w3.org/WAI/WCAG22/Understanding/time-based-media.html](https://www.w3.org/WAI/WCAG22/Understanding/time-based-media.html). Acesso em: 15 nov 2025.

[^wcag33x]: WCAG 2.2 Understanding Docs. SC 3.3 Input Assistance (Overview). Disponível em: [https://www.w3.org/WAI/WCAG22/Understanding/input-assistance.html](https://www.w3.org/WAI/WCAG22/Understanding/input-assistance.html). Acesso em: 15 nov 2025.
