...
## [1. Lighthouse (Google)](https://chromewebstore.google.com/detail/lighthouse/blipmdconlkpinefehnmjammfjpmpbjk?hl=pt-br)
...
## [2. Axe DevTools – Web Accessibility Testing](https://chromewebstore.google.com/detail/axe-devtools-web-accessib/lhdoppojpmngadmnindnejefpokejbdd)
...
**Como usar:** Acesse o site do WAVE e insira a URL desejada ou instale a extensão.  
O relatório apresenta erros, alertas e sugestões diretamente sobre a página analisada.

---

## [4. ASES Web (eMAG) – Governo Federal](https://softwarepublico.gov.br/social/ases)
...
## [5. AccessMonitor](https://accessmonitor.acessibilidade.gov.pt/)
...
## [7. WCAG Color Contrast Checker](https://chromewebstore.google.com/detail/wcag-color-contrast-check/plnahcmalebffmaghcpcmpaciebdhgdf)
...
## [8. HeadingsMap](https://chromewebstore.google.com/detail/headingsmap/flbjommegcjonpdmenkdiocclhjacmbi)
...
## [9. Image Alt Text Viewer](https://chromewebstore.google.com/detail/image-alt-text-viewer/nhmihbneenlkbjjpbimhegikadfleccd)

**Propósito:** Visualizar rapidamente os **textos alternativos (alt text)** de todas as imagens de uma página.  
**Como usar:** Abra o site → clique na extensão → ela exibe sobre cada imagem o texto alternativo ou indica quando está ausente.

---

## [10. Let's Get Color Blind](https://chromewebstore.google.com/detail/lets-get-color-blind/bkdgdianpkfahpkmphgehigalpighjck)
...
## [11. NVDA – Leitor de Tela (Windows)](https://www.nvaccess.org/download/)
...
## [12. JAWS – Leitor de Tela (Windows)](https://www.tecassistiva.com.br/catalogo/jaws/)
...
## [13. TalkBack – Android](https://support.google.com/accessibility/android/answer/6007100?hl=pt-BR)
...
## [14. VoiceOver – iOS (iPhone/iPad/Mac)](https://support.apple.com/pt-br/guide/voiceover/welcome/mac)
...
## [15. Pa11y – Testes Automatizados](https://pa11y.org/)
...
## [16. Funkify – Simulador de Deficiências](https://www.funkify.org/)
